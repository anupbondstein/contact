...

  {
  	 ...
  	 echo "<tr>";
                             ...
                             ?>
                             		...
                             		<td><a href="update.php?id=<?php echo $row['id']; ?>" class="fa fa-pencil" >Edit</a>
                             			<td><a href="address.php?id=<?php echo $row['id']; ?>" class="btn btn-primary" >Address List</a>
                             				<td><a href="phone.php?id=<?php echo $row['id']; ?>" class="btn btn-secondary" >Phone List</a>
                                      <td><a href="details.php?id=<?php echo $row['id']; ?>" class="fa fa-eye" >View Details</a>
                             		</td> 
